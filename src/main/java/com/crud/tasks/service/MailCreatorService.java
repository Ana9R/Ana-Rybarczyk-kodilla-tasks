...
public class MailCreatorService {
    ...
    public String buildTrelloEmailWithMessage(String message) {
        List<String> functionality = new ArrayList<>();
        functionality.add("You can manage your tasks");
        functionality.add("Provides conntextion with Trello Account");
        ...
        context.setVariable("company_details", companyDetailsConfig.getCompanyName() + " - "
