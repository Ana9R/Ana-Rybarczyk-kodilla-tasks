...
public class TrelloClientTest {
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/gucio_289/boards?key=test&token=test&username&fields=name,id&lists=all");
    ...
    public void shouldReturnEmptyList() throws URISyntaxException{
        ...
        //When
        List<TrelloBoardDto> results = trelloClient.getTrelloBoards();
